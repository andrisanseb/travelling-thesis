...
INSERT INTO categories (name, img_path)
VALUES
    ('Culture', 'culture.jpg'),
    ('Gastronomy', 'gastronomy.jpg'),
    ('Nature', 'nature.jpg'),
    ('Leisure','leisure.jpg'),
...
VALUES
   ...
   ('Acropolis', 'Explore the ancient citadel and Parthenon atop the hill.', 20, 120, 8),
   ('Parthenon Museum', 'Visit the museum showcasing artifacts from the Acropolis.', 10, 90, 8),
   ('Plaka District', 'Stroll through the historic neighborhood with shops and tavernas.', 0, 180, 8),
   ('Temple of Olympian Zeus', 'See the ruins of the ancient temple dedicated to Zeus.', 8, 60, 8),
   ('National Archaeological Museum', 'Explore Greece''s largest archaeological museum.', 12, 180, 8),
   ('Mount Lycabettus', 'Hike or take a funicular to the summit for panoramic views.', 0, 90, 8),
   ('Ancient Agora of Athens', 'Visit the historical site that served as a marketplace.', 8, 120, 8),
   ('Syntagma Square', 'Experience the heart of Athens with its historical significance.', 0, 60, 8),
   ('Benaki Museum', 'Explore art and artifacts spanning Greek history.', 8, 90, 8),
   ('Athens Street Food Tour', 'Taste traditional Greek cuisine on a guided food tour.', 25, 180, 8),
   ('Cape Sounion', 'Visit the Temple of Poseidon for sunset views over the Aegean Sea.', 15, 180, 8),
   ('Panathenaic Stadium', 'Explore the historic stadium that hosted the first modern Olympics.', 5, 60, 8),
   ('Byzantine and Christian Museum', 'Discover Byzantine and Christian artifacts and art.', 8, 90, 8),
   ('Gazi Technopolis', 'Experience cultural events and exhibitions in a former gasworks complex.', 0, 120, 8),
   ('Athens War Museum', 'Learn about Greece''s military history through exhibits.', 6, 90, 8),
   ('Filopappou Hill', 'Hike to enjoy panoramic views of Athens and the Acropolis.', 0, 90, 8);
